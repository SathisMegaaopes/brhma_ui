...
//                 backdropFilter: 'blur(3px)', // Adds a blur effect to the background
//             }}
//         >
//             <Box
//                 sx={{
//                     position: 'relative',
//                     width: 400,
//                     bgcolor: status === 1 ? 'success.main' : 'error.main',
//                     color: 'white',
//                     borderRadius: '10px',
//                     p: 3,
//                     textAlign: 'center',
...
//                 alignItems: 'center',
//                 justifyContent: 'center',
//                 backdropFilter: 'blur(5px)', // Stronger blur for a more dramatic effect
//             }}
//         >
//             <Box
//                 sx={{
...
//                         : 'radial-gradient(circle, rgba(255,0,84,1) 0%, rgba(251,212,0,1) 100%)',
//                     color: 'white',
//                     borderRadius: '15px',
//                     p: 4,
//                     textAlign: 'center',
